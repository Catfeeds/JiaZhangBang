...
public class ReciteTextPhaseChose extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState )
	{
		...
		setContentView(R.layout.recite_text_phase_chose);
		intent = getIntent();
		...
		String content = "背课文 " + Util.grade[selected];
	...
	public void reciteTextPhaseChoseFirstPhase(View v )
	{
		...
		intent.setClass(getApplicationContext() ,ReciteTextUnitChose.class);
