...
/**
 * Created by HXL on 16/8/11. 管理录音文件的类
 */
public class FileUtils
{

	// 原始文件(不能播放)
	private final static String AUDIO_PCM_BASEPATH = Util.RECORDPATH_READ;
	// 可播放的高质量音频文件
	private final static String AUDIO_WAV_BASEPATH = Util.RECORDPATH_READ;

	public static String getPcmFileAbsolutePath(String fileBasePath , String fileName )
	{
	...
	public static String getWavFileAbsolutePath(String fileBasePath , String fileName )
	{
		if(fileName == null)
		{
